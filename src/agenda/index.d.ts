...
import { CalendarListProps, CalendarListImperativeMethods } from '../calendar-list';
...
export declare type AgendaProps = CalendarListProps & ReservationListProps & {
    ...
    ref?: React.Ref<CalendarListImperativeMethods>;
...
export default class Agenda extends Component<AgendaProps, State> {
    ...
    static propTypes: {
        ...
        scrollToDay: PropTypes.Requireable<(...args: any[]) => any>;
    ...
    scrollToDay: (d: DateData, offset: number, animated: boolean) => void;
